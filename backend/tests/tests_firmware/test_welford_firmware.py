...
Tolerance : 1e-4 (absolue), PAS 1e-6.
...
Deux familles de cas :
  ...
  2. Capture reelle sur l'accelerometre (150 echantillons a 10Hz = 15s,
     plage +/-4g decidee en B.2) -- verifie sur un vrai signal bruite.
...
if ok_synthetic and ok_real:
    ...
    print("-> Pret a etre integre dans la reecriture groupee du firmware (B.4).")
else:
