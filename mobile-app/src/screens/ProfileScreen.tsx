...
export default function ProfileScreen() {
  ...
  return (
    <View style={[styles.screen, { paddingTop: insets.top }]}>
      <ScreenHeader title="Profil & Paramètres" />
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.avatarSection}>
          ...
          <Text style={styles.avatarTitle}>Éleveur</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.menuGroup}>
            <MenuItem icon="bed-outline" label="Couché" value="< 0.15 g" />
            <MenuItem icon="body-outline" label="Debout" value="0.15 – 0.5 g" />
            <MenuItem icon="walk-outline" label="En marche" value="0.5 – 1.0 g" />
            <MenuItem icon="fitness-outline" label="En course" value="> 1.0 g" last />
          </View>
        </View>
